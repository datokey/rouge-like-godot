...
@export_range(1, 100, 1) var base_beam_count := 1
...
@export_range(0.0, 5.0, 0.05) var out_of_range_grace_time := 0.25
@export_range(0.0, 500.0, 1.0) var lock_range_margin := 30.0
